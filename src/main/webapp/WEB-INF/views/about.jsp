...
<head>
	<title>DistriCampo | Nosotros</title>
	<!-- Meta tag Keywords -->
...
<body>
	...
	<header>
		...
		<nav class="navbar navbar-expand-lg navbar-light px-sm-5 px-3 py-0">
			<h1>
			<a class="navbar-brand py-2" href="index.html">DistriCanoi</a>
		</h1>
	...
	<div class="about-page py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="tittle mb-xl-5 mb-4 text-dark">
				<span class="text-uppercase">Conexión entre Productor y Distribuidor</span>Nosotros</h3>
			<div class="abt-img">
				<h3 class="sub-w3ls-headf text-white text-right pr-4">Compra desde aquí</h3>
			</div>
			<div class="d-flex abtf-info mt-5">
				<div class="about-grids px-4">
					<h5 class="about-w3ls-page font-weight-bold text-dark pb-3">Nuestra idea</h5>
					<p class="paragraphf">Conexión directa entre Productor y distribudor, eliminando los costos de terceros
                                        para generar mayor ingreso</p>
				...
				<div class="about-grids px-4 py-4 my-lg-0 my-4">
					<h5 class="about-w3ls-page font-weight-bold text-dark pb-3">¿Cómo lo hacemos?</h5>
					<p class="paragraphf">
						<i class="fas fa-long-arrow-alt-right"></i> Mediante una aplicacion web</p>
					<p class="paragraphf my-2">
						<i class="fas fa-long-arrow-alt-right"></i> Te conectas ingresas sesion</p>
					<p class="paragraphf">
						<i class="fas fa-long-arrow-alt-right"></i> Consultas las categorias</p>
					<p class="paragraphf my-2">
				...
				<div class="about-grids px-4">
					<h5 class="about-w3ls-page font-weight-bold text-dark pb-3">Disminuimos costos </h5>
	...
	<section class="middle-w3ls py-5 text-center">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="tittle mb-xl-5 mb-4 text-white">Districampo</h3>
			<p>Da inicio a la experiencia de ofrecer o comprar alimentos agricolas.</p>
